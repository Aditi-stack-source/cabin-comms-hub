      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-3 pt-2 border-t border-border">
          <div>
            ...
            <div className="text-base font-semibold text-foreground">{weather.humidity}%</div>
          </div>
          <div>
            ...
            <div className="text-base font-semibold text-foreground">{weather.windSpeed} km/h</div>
          </div>
        </div>
      </div>
    </Card>
